...
- (void)initScreenshotsBroadcaster
{
  ...
  NSLog(@"==========FBConfiguration.mjpegServerPort=00=");
  NSError *error;
  ...
  NSLog(@"==========FBConfiguration.mjpegServerPort===========%ld",(long)FBConfiguration.mjpegServerPort);
}

//-(void)initShMjpegServer{
//  
//  self.shMjpegServer = [[SHMjpegServer alloc]initWithHost:@"192.168.11.7" port:12345];
//  
//}
